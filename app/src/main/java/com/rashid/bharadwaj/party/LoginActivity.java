...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginLayout.setBackgroundResource(R.drawable.party_background_2);
        loginBtn.setBackgroundColor(Color.parseColor("#FFA500"));
        ...
        registerRouteTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
